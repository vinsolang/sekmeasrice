...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="{{ route('submit.approved') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row col-6">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="mb-5">
                                        <label class="block mb-2 text-sm font-medium text-[#0F4634]">Please choose Approved Certificate</label>
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('view.approved') }}"  class="px-6 py-3 border-2 border-[#0F4634] text-[#0F4634] font-semibold rounded-xl hover:bg-[#0F4634] hover:text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-200">
                                    Cancel  
                                </a>
                                <input type="submit"
