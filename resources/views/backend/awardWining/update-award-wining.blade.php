...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="{{ route('submit.update.award') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <input type="hidden" name="update_id" value="{{ $awardWin->id }}">
                                {{-- Upload image --}}
                                <div class="flex gap-4">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <label for="thumbnailFile"
                                            ...
                                            <img id="thumbnailPreview" src="{{ asset('storage/local_product/' . $awardWin->thumbnail) }}"
                                            ...
                                            <input type="hidden" name="old_thumbnail" value="{{ $awardWin->thumbnail }}">
