...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <tr>
                                    <td>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                            <img src="../../storage/local_product/{{ $award->thumbnail }}"
                                                alt="Product Image" class="w-[50px] h-[70px] object-contain rounded">
                                        </ul>
                                    </td>
                                    <td><span class="badge bg-label-primary me-1">{{ $award->created_at }}</span></td>
                                    <td>
                                        <div class="dropdown position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item"
                                                    href="{{ route('update.award', ['id'=>$award->id]) }}"><i
                                                        class="bx bx-edit-alt me-1"></i> Edit</a>
                                                <a href="javascript:void(0);" class="dropdown-item remove-post-key"
                                                    data-id="{{ $award->id }}" data-bs-toggle="modal"
            ...
            <div class="mt-3">
                <form action="{{ route('submit.remove.award') }}" method="post">
                    @csrf
