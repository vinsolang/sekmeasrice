                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                            <img src="../../assets/comments/profile/{{  $comment->profile }}"
                                                alt="Product Image" class="w-[50px] h-[70px] object-contain rounded">
                                        </ul>
                                    </td>
                                    <td>{{ $comment->name }}</td>
                                    <td>{{ $comment->comment }}</td>
                                    <td><span class="badge bg-label-primary me-1">{{ $comment->created_at }}</span></td>
                                    <td>
                                        <div class="dropdown position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item"
                                                    href="{{ route('edit.comment', ['id'=>$comment->id]) }}"><i
